...
namespace StudentSystemManagment.UserCotrollers
{
    public partial class UC_AutoAddition : UserControl
    {
        ...
        private void btnAutoS_Click(object sender, EventArgs e)
        {
            ...
            successAuto.Text = "" + StudentManager.students.Count + " Student added seccsesfuly! ";
            table.SetDataGridView(StudentManager.Sort(StudentManager.GetStudents()));

        }

        private void UC_AutoAddition_Load_1(object sender, EventArgs e)
        {
